...
<h1 id="welcome"><?php __('Speakers'); ?></h1></br>
</div>
<div class="grid_6"></br></div>
<div class="grid_6">
<p id="welc_text"><?php __('The following outstanding neuroscientists will participate:'); ?></p>
<p id="welc_text">
  <div class="spk_list"><?php echo $this->Html->image('por.png', array('alt' => __('Mexico', true))); ?>&nbsp;&nbsp;<?php echo $this->Html->link('Aguilar, Rafael Gutierrez', array('controller' => 'pages', 'action' => 'rafael_gutierrez_aguilar')); ?></div></br>
  ...
  <div class="spk_list"><?php echo $this->Html->image('bra.png', array('alt' => __('Brazil', true))); ?>&nbsp;&nbsp;<?php echo $this->Html->link('Mendez-Otero, Rosalia', array('controller' => 'pages', 'action' => 'rosalia_mentez_otero')); ?></div></br>
