...
<head>
	...
	<?php
		...
		echo $this->Html->css(array('reset', 'text', 'grid', 'layout', 'main_menu', 'navigation'));
		echo '<!--[if IE 6]>'.$this->Html->css('ie6').'<![endif]-->';
		echo '<!--[if IE 7]>'.$this->Html->css('ie').'<![endif]-->';
		echo $this->Html->script(array('jquery-1.3.2.min.js', 'jquery-ui.js', 'jquery-fluid16.js', 'google_analytics.js'));
