<div class="grid_4">	
	<div class="box">			
		...
		<div class="block" id="admin-actions">			
			<h5>Subpages</h5>
			<ul class="menu">
								<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Subpage.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Subpage.id'))); ?></li>
...
<div class="grid_12">
    <h2 id="page-heading"><?php printf(__('Edit %s', true), __('Subpage', true)); ?></h2>
